...
public class RegisterUserExicute extends BaseTest {
	Register register;
	Faker facker = new Faker();
	String fackerFirstName = facker.name().firstName();
	String fackerLastName = facker.name().lastName();   
	String Email = facker.internet().emailAddress();
	String Password = facker.internet().password();
